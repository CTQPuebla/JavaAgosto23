...
public class Tiket {
	...
	public Tiket(String ubiccion, Date fechaHora, int folio, double monto, String cuentaOrigen, String cuentaDestino) {
		super();
	...
	public Tiket(String ubiccion, Date fechaHora, int folio, double monto, String numCuenta) {
		super();
		this.ubiccion = ubiccion;
		this.fechaHora = fechaHora;
		this.folio = folio;
